...
<html lang="en">
  <head>
    ...
    <title>Shop - Show Category Type 2 - Multipurpose Startup SaaS HTML Template</title>
  </head>
  <body>
          ...
          <div class="header-menu"> 
            <div class="header-nav">
              <nav class="nav-main-menu d-none d-xl-block">
                <ul class="main-menu">
                  <li class="has-mega-menu"><a class="active" href="#">Home</a>
                    <div class="sub-menu">
                      <div class="menu-inner">
                        <div class="col-menu">
                          <h6 class="text-16-semibold mb-10 text-uppercase">Home Demo I</h6><a href="index.html">Fashion Store 01</a><a href="index-2.html">Fashion Store 02</a><a href="index-3.html">Fashion Store 03</a><a href="index-4.html">Fashion Store 04</a><a href="index-5.html">Fashion Store 05</a><a href="index-6.html">Fashion Store 06</a><a href="index-25.html">Fashion Store 07</a><a href="index-18.html">Fashion Store 08</a><a href="index-22.html">Fashion Store 09</a>
                        </div>
                        <div class="col-menu">
                          <h6 class="text-16-semibold mb-10 text-uppercase">Home Demo II</h6><a href="index-26.html">Shoes</a><a href="index-15.html">Natural Skins</a><a href="index-27.html">Phonecases</a><a href="index-28.html">Yoga Clothing</a><a href="index-29.html">Jewelry Store</a><a href="index-30.html">Socks Store</a><a href="index-7.html">Underwear Store</a><a href="index-10.html">Home Living</a>
                        </div>
                        <div class="col-menu">
                          <h6 class="text-16-semibold mb-10 text-uppercase">Home Demo III</h6><a href="index-11.html">Pets Store</a><a href="index-16.html">Electronic</a><a href="index-17.html">Food Store</a><a href="index-31.html">Watch Store</a><a href="index-32.html">Book Store</a><a href="index-33.html">Glasses Shop</a><a href="index-34.html">Jeans Fashion</a><a href="index-8.html">Furniture Store 01</a><a href="index-9.html">Furniture Store 02</a>
                        </div>
                        <div class="col-menu">
                          <h6 class="text-16-semibold mb-10 text-uppercase">Home Demo IV</h6><a href="index-12.html">Oganic Store</a><a href="index-13.html">Toys Store</a><a href="index-14.html">Skateboard Store</a><a href="index-19.html">Plants Store</a><a href="index-20.html">Bikes Store</a><a href="index-21.html">Baby Clothing</a><a href="index-23.html">Travel gear</a><a href="index-24.html">Coffee Shop</a>
                        </div>
                        <div class="col-menu"><img src="assets/imgs/template/banner-menu.webp" alt="Guza"></div>
                      </div>
                    </div>
                  </li>
                  ...
                  <li class="has-mega-menu"><a href="#">Products</a>
                    <div class="sub-menu">
                      <div class="menu-inner">
                        ...
                        <div class="col-menu"><img src="assets/imgs/template/banner-menu-2.png" alt="Guza"></div>
                      </div>
                    </div>
                  </li>
      ...
      <div class="mobile-header-wrapper-inner">
        <div class="mobile-header-content-area">
          <div class="mobile-menu-head">
            <div class="box-head-1"><a class="link-underline mr-20 account-icon account" href="#">Login</a><a class="link-underline account-icon account" href="#">Sign Up</a><a class="close-mobile" href="#"><img src="assets/imgs/template/icons/close.svg" alt="Guza"></a></div>
            <div class="box-head-2"><a class="back-mobile" href="#"><img src="assets/imgs/template/icons/back.svg" alt="Guza"></a></div>
          </div>
      ...
      <section class="section block-content-shop">
        <div class="container">
                ...
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <div class="cardCategorySmall cardCategorySmallStyle2 wow fadeInUp">
                      <div class="cardImage"><a href="#"><img src="assets/imgs/page/shop6/kitchen.png" alt="Guza"></a></div>
                      <div class="cardInfo"><a href="#">
                          <h4 class="cardTitle">Kitchen (8)</h4></a></div>
                    </div>
                  </div>
                  <div class="swiper-slide">
                    <div class="cardCategorySmall cardCategorySmallStyle2 wow fadeInUp">
                      <div class="cardImage"><a href="#"><img src="assets/imgs/page/shop6/accessories.png" alt="Guza"></a></div>
                      <div class="cardInfo"><a href="#">
                          <h4 class="cardTitle">Accessories (12)</h4></a></div>
                    </div>
                  </div>
                  <div class="swiper-slide">
                    <div class="cardCategorySmall cardCategorySmallStyle2 wow fadeInUp">
                      <div class="cardImage"><a href="#"><img src="assets/imgs/page/shop6/medical.png" alt="Guza"></a></div>
                      <div class="cardInfo"><a href="#">
                          <h4 class="cardTitle">Medical (4)</h4></a></div>
                    </div>
                  </div>
                  <div class="swiper-slide">
                    <div class="cardCategorySmall cardCategorySmallStyle2 wow fadeInUp">
                      <div class="cardImage"><a href="#"><img src="assets/imgs/page/shop6/headphone.png" alt="Guza"></a></div>
                      <div class="cardInfo"><a href="#">
                          <h4 class="cardTitle">Hi-Tech (5)</h4></a></div>
                    </div>
                  </div>
                  <div class="swiper-slide">
                    <div class="cardCategorySmall cardCategorySmallStyle2 wow fadeInUp">
                      <div class="cardImage"><a href="#"><img src="assets/imgs/page/shop6/travel.png" alt="Guza"></a></div>
                      <div class="cardInfo"><a href="#">
                          <h4 class="cardTitle">Travel (3)</h4></a></div>
                    </div>
                  </div>
                  <div class="swiper-slide">
                    <div class="cardCategorySmall cardCategorySmallStyle2 wow fadeInUp">
                      <div class="cardImage"><a href="#"><img src="assets/imgs/page/shop6/bag.png" alt="Guza"></a></div>
                      <div class="cardInfo"><a href="#">
                          <h4 class="cardTitle">Bags (6)</h4></a></div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="box-filter-top"> 
            <div class="show-sm show-lg"> <a class="btn-open-filter" href="#">Filter </a></div>
            <div class="wrapper-overlay"></div>
            <div class="box-filters box-filters-left"> <span class="body-p2 neutral-medium-dark">Filter by</span>
              <div class="dropdown dropdown-sort">
                <button class="btn dropdown-toggle" id="dropdownCat" type="button" data-bs-toggle="dropdown" aria-expanded="false">Categories</button>
                <div class="dropdown-menu dropdown-menu-light dropdown-menu-filter dropdown-menu-category" aria-labelledby="dropdownCat" style="margin: 0px;">
                      ...
                      <ul class="list-filter-checkbox"> 
                        <li> 
                          <label class="cb-container">
                            <input type="checkbox"><span class="text-small">Womens <span class="neutral-medium">(12)</span></span><span class="checkmark"></span>
                          </label><span class="arrow-down"></span>
                        </li>
                        <li> 
                          <label class="cb-container">
                            <input type="checkbox"><span class="text-small">Mens <span class="neutral-medium">(9)</span></span><span class="checkmark"></span>
                          </label><span class="arrow-down"></span>
                          <ul> 
                            <li> 
                              <label class="cb-container">
                                <input type="checkbox"><span class="text-small">Hats<span class="neutral-medium">(4)</span></span><span class="checkmark"></span>
                              </label>
                            </li>
                            <li> 
                              <label class="cb-container">
                                <input type="checkbox"><span class="text-small">Glasses <span class="neutral-medium">(3)</span></span><span class="checkmark"></span>
                              </label>
                            </li>
                            <li> 
                              <label class="cb-container">
                                <input type="checkbox"><span class="text-small">Jeans<span class="neutral-medium">(2)</span></span><span class="checkmark"></span>
                              </label>
                            </li>
                          </ul>
                        </li>
                        <li> 
                          <label class="cb-container">
                            <input type="checkbox"><span class="text-small">Kids <span class="neutral-medium">(15)</span></span><span class="checkmark"></span>
                          </label><span class="arrow-down"></span>
                        </li>
                        <li> 
                          <label class="cb-container">
                            <input type="checkbox"><span class="text-small">Gifts <span class="neutral-medium">(10)</span></span><span class="checkmark"></span>
                          </label><span class="arrow-down"></span>
                        </li>
                      </ul>
                    </div>
              ...
              <div class="dropdown dropdown-sort">
                <button class="btn dropdown-toggle" id="dropdownColor" type="button" data-bs-toggle="dropdown" aria-expanded="false">Color</button>
                <div class="dropdown-menu dropdown-menu-light dropdown-menu-filter" aria-labelledby="dropdownColor" style="margin: 0px;">
                  <div class="box-dropdown-filter">
                    <h6 class="head-filter">Colors </h6>
                    <div class="box-collapse">
              ...
              <div class="dropdown dropdown-sort">
                <button class="btn dropdown-toggle" id="dropdownSize" type="button" data-bs-toggle="dropdown" aria-expanded="false">Size</button>
                <div class="dropdown-menu dropdown-menu-light dropdown-menu-filter" aria-labelledby="dropdownSize" style="margin: 0px;">
                  <div class="box-dropdown-filter">
                    <h6 class="head-filter">Size </h6>
                    <div class="box-collapse">
                      <ul class="list-filter-checkbox"> 
                        <li> 
                          <label class="cb-container">
                            <input type="checkbox"><span class="text-small">S <span class="neutral-medium">(3)</span></span><span class="checkmark"></span>
                          </label>
                        </li>
                        <li> 
                          <label class="cb-container">
                            <input type="checkbox"><span class="text-small">L <span class="neutral-medium">(9)</span></span><span class="checkmark"></span>
                          </label>
                        </li>
                        <li> 
                          <label class="cb-container">
                            <input type="checkbox"><span class="text-small">M <span class="neutral-medium">(4)</span></span><span class="checkmark"></span>
                          </label>
                        </li>
                        <li> 
                          <label class="cb-container">
                            <input type="checkbox"><span class="text-small">XL <span class="neutral-medium">(5)</span></span><span class="checkmark"></span>
                          </label>
                        </li>
                      </ul>
                    </div>
              ...
              <div class="dropdown dropdown-sort">
                <button class="btn dropdown-toggle" id="dropdownBrand" type="button" data-bs-toggle="dropdown" aria-expanded="false">Brand</button>
                <div class="dropdown-menu dropdown-menu-light dropdown-menu-filter" aria-labelledby="dropdownBrand" style="margin: 0px;">
                  <div class="box-dropdown-filter">
                    <h6 class="head-filter">Brand </h6>
                    <div class="box-collapse">
                      <ul class="list-filter-checkbox"> 
                        <li> 
                          <label class="cb-container">
              ...
              <div class="dropdown dropdown-sort">
                <button class="btn dropdown-toggle" id="dropdownRrice" type="button" data-bs-toggle="dropdown" aria-expanded="false">Price</button>
                <div class="dropdown-menu dropdown-menu-light dropdown-menu-filter dropdown-menu-category" aria-labelledby="dropdownRrice" style="margin: 0px;">
                  <div class="box-dropdown-filter">
                    <h6 class="head-filter">Price </h6>
          ...
          <div class="box-list-products box-list-products-4 box-list-products-shop-2">
            <div class="product-item">
              <div class="cardProduct wow fadeInUp">
                <div class="cardImage"><a href="#"><img class="imageMain" src="assets/imgs/page/homepage1/product8.png" alt="guza"><img class="imageHover" src="assets/imgs/page/homepage1/product1-hover.png" alt="guza"></a>
            ...
            <div class="product-item">
              <div class="cardProduct wow fadeInUp">
                <div class="cardImage"><a href="#"><img class="imageMain" src="assets/imgs/page/homepage1/product7.png" alt="guza"><img class="imageHover" src="assets/imgs/page/homepage1/product1-hover.png" alt="guza"></a>
                  <div class="button-select"><a href="#">Select Options</a></div>
                  <div class="box-quick-button"><a class="btn" href="#">
                      <svg class="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewbox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_116_452)">
            ...
            <div class="product-item">
              <div class="cardProduct wow fadeInUp">
                <div class="cardImage"><a href="#"><img class="imageMain" src="assets/imgs/page/homepage1/product6.png" alt="guza"><img class="imageHover" src="assets/imgs/page/homepage1/product1-hover.png" alt="guza"></a>
                  <div class="button-select"><a href="#">Select Options</a></div>
                  <div class="box-quick-button"><a class="btn" href="#">
                      <svg class="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewbox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_116_452)">
            ...
            <div class="product-item">
              <div class="cardProduct wow fadeInUp">
                <div class="cardImage"><a href="#"><img class="imageMain" src="assets/imgs/page/homepage1/product5.png" alt="guza"><img class="imageHover" src="assets/imgs/page/homepage1/product1-hover.png" alt="guza"></a>
                  <div class="button-select"><a href="#">Select Options</a></div>
                  <div class="box-quick-button"><a class="btn" href="#">
                      <svg class="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewbox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_116_452)">
            ...
            <div class="product-item">
              <div class="cardProduct wow fadeInUp">
                <div class="cardImage"><a href="#"><img class="imageMain" src="assets/imgs/page/homepage1/product4.png" alt="guza"><img class="imageHover" src="assets/imgs/page/homepage1/product1-hover.png" alt="guza"></a>
                  <div class="button-select"><a href="#">Select Options</a></div>
                  <div class="box-quick-button"><a class="btn" href="#">
                      <svg class="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewbox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_116_452)">
            ...
            <div class="product-item">
              <div class="cardProduct wow fadeInUp">
                <div class="cardImage"><a href="#"><img class="imageMain" src="assets/imgs/page/homepage1/product3.png" alt="guza"><img class="imageHover" src="assets/imgs/page/homepage1/product1-hover.png" alt="guza"></a>
                  <div class="button-select"><a href="#">Select Options</a></div>
                  <div class="box-quick-button"><a class="btn" href="#">
                      <svg class="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewbox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_116_452)">
            ...
            <div class="product-item">
              <div class="cardProduct wow fadeInUp">
                <div class="cardImage"><a href="#"><img class="imageMain" src="assets/imgs/page/homepage1/product2.png" alt="guza"><img class="imageHover" src="assets/imgs/page/homepage1/product1-hover.png" alt="guza"></a>
                  <div class="button-select"><a href="#">Select Options</a></div>
                  <div class="box-quick-button"><a class="btn" href="#">
                      <svg class="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewbox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_116_452)">
            ...
            <div class="product-item">
              <div class="cardProduct wow fadeInUp">
                <div class="cardImage"><a href="#"><img class="imageMain" src="assets/imgs/page/homepage1/product1.png" alt="guza"><img class="imageHover" src="assets/imgs/page/homepage1/product1-hover.png" alt="guza"></a>
                  <div class="button-select"><a href="#">Select Options</a></div>
                  <div class="box-quick-button"><a class="btn" href="#">
                      <svg class="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewbox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_116_452)">
    ...
    <div class="box-popup-preview"><a class="btn-close-popup" href="#"><img src="assets/imgs/template/icons/close-popup.svg" alt="kidify"></a>
      <div class="box-popup-content">
        <div class="preview-product-image">
          <div class="detail-gallery detail-gallery-2">
            <div class="box-main-gallery"><a class="zoom-image glightbox" href="assets/imgs/page/product/img.png"></a>
              <div class="product-image-slider product-image-slider-preview">
                <figure class="border-radius-10"><a class="glightbox" href="assets/imgs/page/product/img.png"><img src="assets/imgs/page/product/img.png" alt="kidify"></a></figure>
                <figure class="border-radius-10"><a class="glightbox" href="assets/imgs/page/product/img.png"><img src="assets/imgs/page/product/img.png" alt="kidify"></a></figure>
                <figure class="border-radius-10"><a class="glightbox" href="assets/imgs/page/product/img.png"><img src="assets/imgs/page/product/img.png" alt="kidify"></a></figure>
                <figure class="border-radius-10"><a class="glightbox" href="assets/imgs/page/product/img.png"><img src="assets/imgs/page/product/img.png" alt="kidify"></a></figure>
                <figure class="border-radius-10"><a class="glightbox" href="assets/imgs/page/product/img.png"><img src="assets/imgs/page/product/img.png" alt="kidify"></a></figure>
        ...
        <div class="preview-product-info">
          <div class="box-product-info">
            ...
            <div class="block-rating"><img src="assets/imgs/template/icons/star-fill.svg" alt="Guza"><img src="assets/imgs/template/icons/star-fill.svg" alt="Guza"><img src="assets/imgs/template/icons/star-fill.svg" alt="Guza"><img src="assets/imgs/template/icons/star-fill.svg" alt="Guza"><img src="assets/imgs/template/icons/star-none.svg" alt="Guza"><span class="text-17 neutral-medium-dark">(5)</span></div>
            <div class="block-price"><span class="price-main">$15.00</span><span class="price-line">$25.00</span></div>
            <p class="body-p2 viewed-guest viewed-guest-black mb-25"><span class="text-17-medium">24 guests are viewing this product</span></p>
            <div class="block-description">
              <p class="body-p2 neutral-medium-dark">The shorts are made from soft organic cotton. They have an elasticated waistband with an internal drawstring and side pockets.</p>
            </div>
          ...
          <div class="box-list-product-search">
            <div class="item-product-search">
              <div class="cardProductStyle3 cardProductType03 cardProductType02 wow fadeInUp">
                <div class="cardImage"><a href="#"><img class="imageMain" src="assets/imgs/page/popup/product-1.png" alt="guza"><img class="imageHover" src="assets/imgs/page/popup/product-5.png" alt="guza"></a>
                  <div class="button-select"><a href="#">Select Options</a></div>
                  <div class="box-quick-button"><a class="btn" href="#">
                      <svg class="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewbox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_116_452)">
            ...
            <div class="item-product-search">
              <div class="cardProductStyle3 cardProductType03 cardProductType02 wow fadeInUp">
                <div class="cardImage"><a href="#"><img class="imageMain" src="assets/imgs/page/popup/product-2.png" alt="guza"><img class="imageHover" src="assets/imgs/page/popup/product-6.png" alt="guza"></a>
                  <div class="button-select"><a href="#">Select Options</a></div>
                  <div class="box-quick-button"><a class="btn" href="#">
                      <svg class="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewbox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_116_452)">
            ...
            <div class="item-product-search">
              <div class="cardProductStyle3 cardProductType03 cardProductType02 wow fadeInUp">
                <div class="cardImage"><a href="#"><img class="imageMain" src="assets/imgs/page/popup/product-3.png" alt="guza"><img class="imageHover" src="assets/imgs/page/popup/product-7.png" alt="guza"></a>
                  <div class="button-select"><a href="#">Select Options</a></div>
                  <div class="box-quick-button"><a class="btn" href="#">
                      <svg class="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewbox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_116_452)">
            ...
            <div class="item-product-search">
              <div class="cardProductStyle3 cardProductType03 cardProductType02 wow fadeInUp">
                <div class="cardImage"><a href="#"><img class="imageMain" src="assets/imgs/page/popup/product-4.png" alt="guza"><img class="imageHover" src="assets/imgs/page/popup/product-8.png" alt="guza"></a>
                  <div class="button-select"><a href="#">Select Options</a></div>
                  <div class="box-quick-button"><a class="btn" href="#">
                      <svg class="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewbox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_116_452)">
          ...
          <div class="form-register">
            ...
            <div class="form-group">
              <label class="d-flex align-items-start">
                <input class="cb-agree" type="checkbox"><span class="text-agree body-p2">Join for Free and start earning points today. Benefits include 15% off your first purchase,</span>
              </label>
            </div>
            <div class="form-group">
      ...
      <div class="box-cart-wrapper"><a class="btn-close-popup" href="#">
        ...
        <div class="box-products-cart">
          ...
          <div class="list-items-cart">
            ...
            <div class="item-cart">
              <div class="item-cart-image"><img src="assets/imgs/page/cart/sp2.png" alt="Guza"></div>
              <div class="item-cart-info">
                <div class="item-cart-info-1"><a class="text-16-medium" href="#">Ball Crew Shirt</a>
                  <div class="box-info-size-color-product">
                    <p class="box-color"><span class="body-p2 neutral-medium-dark">Color:</span><span class="body-p2 neutral-dark">Navy</span></p>
        ...
        <div class="box-products-search">
          ...
          <div class="box-list-product-search">
            <div class="item-product-search">
              <div class="cardProductStyle3 cardProductType03 cardProductType02 wow fadeInUp">
                <div class="cardImage"><a href="#"><img class="imageMain" src="assets/imgs/page/shop1/sp.png" alt="guza"><img class="imageHover" src="assets/imgs/page/shop1/sp.png" alt="guza"></a>
                  <div class="button-select"><a href="#">Select Options</a></div>
                  <div class="box-quick-button"><a class="btn" href="#">
                      <svg class="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewbox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_116_452)">
                ...
                <div class="cardInfo">
                  <h6 class="text-16-medium">Ball Crew Shirt</h6>
                  <p class="body-p2 cardDesc">$35.00</p>
                </div>
              </div>
            </div>
            <div class="item-product-search">
              <div class="cardProductStyle3 cardProductType03 cardProductType02 wow fadeInUp">
                <div class="cardImage"><a href="#"><img class="imageMain" src="assets/imgs/page/shop1/sp2.png" alt="guza"><img class="imageHover" src="assets/imgs/page/shop1/sp2.png" alt="guza"></a>
                  <div class="button-select"><a href="#">Select Options</a></div>
                  <div class="box-quick-button"><a class="btn" href="#">
                      <svg class="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewbox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_116_452)">
        ...
        <div class="box-fire">
          <div class="icon-fire body-p2">Checkout now 09:14 before they’re<span class="text-17-medium">GONE!</span></div>
        </div>
        ...
        <div class="box-button-popup-cart d-flex align-items-center justify-content-between"><a class="btn btn-border w-100 mr-5" href="cart.html">View Cart</a><a class="btn btn-black w-100 ml-5" href="checkout.html">Check Out</a></div>
      </div>
    </div>
      ...
      <div class="box-wishlist-wrapper"><a class="btn-close-popup" href="#">
        ...
        <div class="box-products-cart">
          ...
          <div class="list-items-cart">
            ...
            <div class="item-cart">
              <div class="item-cart-image"><img src="assets/imgs/page/cart/sp3.png" alt="Guza"></div>
              <div class="item-cart-info">
                <div class="item-cart-info-1"><a class="text-16-medium" href="#">Ball Crew Shirt</a>
                  <div class="box-info-size-color-product">
                    <p class="box-color"><span class="body-p2 neutral-medium-dark">Color:</span><span class="body-p2 neutral-dark">Navy</span></p>
